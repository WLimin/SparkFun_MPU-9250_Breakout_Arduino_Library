...
int myLed  = LED_BUILTIN;//13;  // Set up pin 13 led for toggling
...
void setup() {
	...
	byte c = myIMU.readWhoAmI_Mpu9250();
	Serial.print(F("MPU9250 I AM 0x"));
	Serial.print(c, HEX);
	Serial.print(F(" I should be 0x"));
	Serial.println(WAI_MPU_9255, HEX); //0x73 is MPU-9255

	if (c == WAI_MPU_9255) { // WHO_AM_I should always be 0x71
		...
		// communication
		byte d = myIMU.readWhoAmI_AK8963();
		Serial.print("AK8963 ");

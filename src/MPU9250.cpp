...
MPU9250::MPU9250() :
		_I2Caddr( MPU9250_ADDRESS_AD0)	// Use AD0 by default
{
...
uint8_t MPU9250::readIntStatus(void) {
	return readByte(_I2Caddr, INT_STATUS);
}

uint8_t MPU9250::readWhoAmI_AK8963(void) {
	return readByte(AK8963_ADDRESS, WHO_AM_I_AK8963);
}

uint8_t MPU9250::readWhoAmI_Mpu9250(void) {
	return readByte(_I2Caddr, WHO_AM_I_MPU9250);
}
